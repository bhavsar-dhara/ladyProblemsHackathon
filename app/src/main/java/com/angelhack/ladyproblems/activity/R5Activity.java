...
public class R5Activity extends AppCompatActivity {
    ...
    public void increase(View view){
        finalResult.getInstance().setFlow(new flow(f_increase));
        Intent intent = new Intent(this, R6Activity.class);
        startActivity(intent);
    }

    public void same(View view){
        finalResult.getInstance().setFlow(new flow(f_same_as_before));
        Intent intent = new Intent(this, R6Activity.class);
        startActivity(intent);
    }

    public void decrease(View view){
        finalResult.getInstance().setFlow(new flow(f_decrease));
        Intent intent = new Intent(this, R6Activity.class);
        startActivity(intent);
    }
}
